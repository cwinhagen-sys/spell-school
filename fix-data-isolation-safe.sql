...
-- 3. Drop ALL existing policies to start fresh (with IF EXISTS to avoid errors)
DROP POLICY IF EXISTS "classes_teacher_only" ON classes;
...
DROP POLICY IF EXISTS "student_progress_student_only" ON student_progress;
