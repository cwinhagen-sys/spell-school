...
export type GameType = 'flashcards' | 'match' | 'typing' | 'story' | 'translate' | 'connect' | 'quiz' | 'choice' | 'roulette' | 'story_gap' | 'story_builder' | 'daily_quest' | 'pronunciation' | 'spellslinger' | 'distorted_tale' | 'scenario_adventure' | 'scramble'
