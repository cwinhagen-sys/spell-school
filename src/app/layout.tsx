...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: '/favicon.ico?v=11', sizes: '32x32', type: 'image/png' },
      { url: '/favicon-16.png?v=11', sizes: '16x16', type: 'image/png' },
      { url: '/favicon-48.png?v=11', sizes: '48x48', type: 'image/png' },
    ],
    apple: [
  ...
  return (
    <html lang="sv">
      <head>
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="/favicon.ico?v=11" />
