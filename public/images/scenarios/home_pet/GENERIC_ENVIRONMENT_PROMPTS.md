# Generic Environment Images - Comic Book Style

## Style Guide
All images should be:
- **Comic book illustration style** - bold lines, vibrant colors, clear panels
- **Environment-focused** - show the setting, not characters
- **No people or animals** - just the environment and objects
- **Consistent color palette** - warm, friendly, child-appropriate
- **Clean and simple** - focus on key elements
...
### 1. seg_schedule.png
**Environment:** Kitchen with schedule note
...
### 2. seg_memory.png
**Environment:** Kitchen or hallway (uncertain/thinking atmosphere)
...
### 5. seg_breakfast.png
**Environment:** Kitchen with dog bowls (properly filled)
...
### 6. seg_afternoon.png
**Environment:** Backyard (play area)
...
### 7. seg_forgot.png
**Environment:** Room with gaming setup, empty bowls visible
...
**Environment:** Evening walk scene OR home with full bowls

**Prompt Option A (Evening walk):**
```
Comic book illustration style. A peaceful evening neighborhood scene. A sidewalk path. The sun is setting with warm orange and pink colors in the sky. A leash visible on the ground or hanging. Calm, peaceful, successful atmosphere. Bold lines, warm sunset colors, comic book panel style. No people, no animals. Focus on the evening walk setting.
```

**Prompt Option B (Home success):**
```
...
### 9. ending_okay.png
**Environment:** Home interior with partially filled bowls
...
### 10. ending_fail.png
**Environment:** Home interior with completely empty bowls
...
## Additional: seg_walk.png (if needed)
**Environment:** Neighborhood sidewalk

**Prompt:**
```
Comic book illustration style. A friendly neighborhood sidewalk scene. Houses in the background. Trees along the street. A leash visible on the ground or sidewalk. Morning light, fresh atmosphere. Happy, active, outdoor walk setting. Bold lines, vibrant colors, comic book panel style. No people, no animals. Focus on the neighborhood and sidewalk environment.
```
...
**Style to add to ALL:**
"Comic book illustration style, bold lines, vibrant colors, comic book panel style. No people, no animals."

**Common Elements:**
- Focus on environment and objects
- Show mood through lighting and atmosphere
- Clean, simple compositions
- Child-appropriate, friendly aesthetic

---

## Tips for Generation

1. **Consistent Style:** Use the same "comic book illustration style" description for all
2. **Color Mood:**
   - Morning: Cool, fresh blues and whites
   - Afternoon: Warm golden tones
   - Evening: Warm sunset colors
   - Success: Bright, vibrant
   - Failure: Muted, sadder tones
3. **Composition:** Keep it simple, focus on key objects (bowls, table, door, etc.)
4. **Atmosphere:** Let lighting and objects tell the story
