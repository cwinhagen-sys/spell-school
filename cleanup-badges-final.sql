...
-- Using existing categories from the database

-- 1. Remove all existing badges and user badges
DELETE FROM user_badges;
DELETE FROM badges;

-- 2. Create only the 18 badges we need using existing categories
...
-- Daily Quest Badges (8 badges) - using 'general' category
(gen_random_uuid(), 'Word Warrior', 'Complete 3 games of any type', '🏆⚔️', 'general', 'common', 'Complete 3 games of any type', 'count', 3, NOW(), NOW()),
(gen_random_uuid(), 'Memory Champion', 'Complete 2 Memory Games', '🏆🧠', 'memory', 'common', 'Complete 2 Memory Games', 'count', 2, NOW(), NOW()),
(gen_random_uuid(), 'Spelling Bee', 'Complete 1 Typing Challenge', '🏆⌨️', 'typing', 'common', 'Complete 1 Typing Challenge', 'count', 1, NOW(), NOW()),
(gen_random_uuid(), 'Choice Master', 'Complete 3 perfect games of multiple choice', '🏆✅', 'quiz', 'uncommon', 'Complete 3 perfect games of multiple choice', 'count', 3, NOW(), NOW()),
(gen_random_uuid(), 'Gap Filler', 'Get a perfect result in sentence gap', '🏆📝', 'general', 'uncommon', 'Get a perfect result in sentence gap', 'count', 1, NOW(), NOW()),
(gen_random_uuid(), 'Spell Slinger Novice', 'Score 100+ points in Spell Slinger', '🏆✨', 'general', 'rare', 'Score 100+ points in Spell Slinger', 'score', 100, NOW(), NOW()),
(gen_random_uuid(), 'Sentence Builder', 'Complete 2 Sentence Gap games', '🏆📝', 'general', 'rare', 'Complete 2 Sentence Gap games', 'count', 2, NOW(), NOW()),
(gen_random_uuid(), 'Roulette Master', 'Get 3 perfect sentences in Word Roulette', '🏆🎯', 'roulette', 'rare', 'Get 3 perfect sentences in Word Roulette', 'count', 3, NOW(), NOW()),
